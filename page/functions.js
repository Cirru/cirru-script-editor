...
var atHead, atTail, backspace, caret, clear, create_block, ctrl_m, ctrl_p, ctrl_y, empty, found, has_caret, inHead, inTail, insert_char, isArr, isCell, isStr, key_delete, last, move_down, move_end, move_home, move_left, move_right, move_up, page_down, point, rm_caret, show, spacebar,
  __slice = [].slice,
...
exports.ctrl_m = ctrl_m = function(list) {
  var ret;
  ret = [];
  list.forEach(function(item) {
    if (isStr(item)) {
...
exports.ctrl_y = ctrl_y = function(list) {
  list.forEach(function(item) {
    if (isStr(item)) {
      if (point(item)) {
...
exports.ctrl_p = ctrl_p = function(list) {
  var ret;
  ret = [];
  list.forEach(function(item) {
    if (isStr(item)) {
